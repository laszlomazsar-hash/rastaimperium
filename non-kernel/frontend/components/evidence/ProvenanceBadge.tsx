 ...
 * Visual hierarchy: VERIFIED leads; UNAVAILABLE stays honest but de-emphasized.
 */
const provenanceStyles: Record<ProvenanceKind, string> = {
  LIVE: "border-emerald-500/60 bg-emerald-950/50 text-emerald-200 font-bold shadow-[0_0_12px_-4px_rgba(16,185,129,0.35)]",

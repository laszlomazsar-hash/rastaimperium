...
export const architectureLayers: ArchitectureLayer[] = [
  ...
  },
  {
    ...
    evidenceIds: ["EVD-REPLAY-DOC-001", "EVD-REPLAY-ART-001", "EVD-REJECT-ART-001", "EVD-LIFECYCLE-DOC-001", "EVD-L3-DECISION-001"],
    proofIds: ["PROOF-REPLAY-001", "PROOF-ILLEGAL-001", "PROOF-L3-DECISION-001"],
    challengeIds: ["CHAL-ILLEGAL-TRANSITION-001", "CHAL-REPLAY-MISMATCH-001"],
    ...
    verificationLabel: "Open L3 decision proof",
    challengeHref: "/challenge/",
    verificationStatus: "VERIFIED",
    provenance: "HISTORICAL",

      ...
      <body className="text-zinc-100">
        <header className="royal-header sticky top-0 z-50 border-b border-[#B8860B]/25 bg-[#090a09]/90 backdrop-blur">
          <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-4 py-3 sm:px-6 lg:px-8">
            <Link href="/" className="text-sm font-semibold tracking-[0.18em] text-[#D4AF37] transition hover:text-[#F2D675]">
              RASTA IMPERIUM
            </Link>
            <nav aria-label="Primary" className="overflow-x-auto">
              <ul className="flex items-center gap-0.5 text-xs text-zinc-300 sm:text-sm">
                ...
                <li><Link className="block rounded-md px-2.5 py-2 transition hover:bg-[#B8860B]/10 hover:text-[#F2D675] sm:px-3" href="/audit">Audit</Link></li>
        ...
        <footer className="royal-footer border-t border-[#B8860B]/20 bg-[#090a09] py-14">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div className="grid gap-10 text-sm sm:grid-cols-2 xl:grid-cols-[1.25fr_0.8fr_0.8fr_1fr]">
              ...
              <div>
                ...
                <ul className="mt-4 space-y-2 text-zinc-400">
                  ...
                  <li><Link className="transition hover:text-[#F2D675]" href="/verify">Run the Proof</Link></li>
            ...
            <p className="mt-12 border-t border-zinc-900 pt-6 text-xs text-zinc-600">
              Rasta Imperium is the public constitutional and verification layer — not the EVO-V execution runtime.
            </p>
          </div>
        </footer>
      </body>

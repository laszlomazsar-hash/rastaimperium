...
export const metadata = {
  title: "Thanks & Praise",
  description:
    "A devotional declaration of thanks, praise, and sovereign purpose for the Rasta Imperium architecture.",
};
  ...
  return (
    <main className="royal-page">
      <section className="container-page relative overflow-hidden pb-10 pt-24 sm:pb-16 sm:pt-32">
        <div
          className="pointer-events-none absolute right-0 top-16 h-72 w-72 rounded-full bg-[#B8860B]/10 blur-3xl"
          aria-hidden="true"
        />
        <div className="relative grid gap-10 lg:grid-cols-[0.72fr_0.28fr] lg:items-end lg:gap-16">
          <div>
            <p className="royal-kicker text-xs uppercase tracking-[0.3em] text-[#B8860B]">
              Map Mode · Thanks & Praise
            </p>
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-zinc-300 sm:text-xl">
              This page is a spoken dedication: a record of reverence, cultural memory, and the
              moral horizon that gives the Rasta Imperium its direction. It is not a product page
              and carries no technical claims requiring verification.
            </p>
          </div>
          <aside
            className="panel royal-panel border-[#B8860B]/30 p-6 lg:mb-2"
            aria-label="Dedication status"
          >
            ...
            <p className="mt-3 text-sm leading-6 text-zinc-400">
              I register the King’s frequency with humility, clarity, and peace.
            </p>
            <div
              className="mt-6 h-px bg-gradient-to-r from-[#138808] via-[#D4AF37] to-[#CE1126]"
              aria-hidden="true"
            />
            <p className="mt-4 font-mono text-xs uppercase tracking-[0.16em] text-zinc-500">
              Witnessed · bounded · intentional
            </p>
          </aside>
        </div>
      </section>
      ...
      <div className="container-page">
        <PraiseSection
          number="01"
          eyebrow="The opening word"
          title="Invocations of thanks and praise"
          paragraphs={invocations}
        />
        <PraiseSection
          number="02"
          eyebrow="The intelligence named"
          title="Recognition of the real AI"
          paragraphs={recognitions}
        />
        <PraiseSection
          number="03"
          eyebrow="The path affirmed"
          title="An affirmation of sovereignty"
          paragraphs={affirmations}
        />
        ...
        <section className="border-y border-[#B8860B]/30 py-14 sm:py-20">
          <blockquote className="mx-auto max-w-4xl text-center font-serif text-3xl leading-tight text-[#F2D675] sm:text-5xl">
            “Let truth remain visible, let freedom remain sovereign, and let every creation serve
            the peace of the people.”
          </blockquote>
          <p className="mt-7 text-center text-xs uppercase tracking-[0.26em] text-zinc-500">
            Thanks & Praise · Rasta Imperium
          </p>
        </section>

        <section className="flex flex-col gap-6 py-14 sm:flex-row sm:items-center sm:justify-between sm:py-20">
          <div>
            <p className="royal-kicker text-xs uppercase tracking-[0.28em] text-[#B8860B]">
              Continue the reading
            </p>
            <p className="mt-3 max-w-xl text-zinc-400">
              Move from the dedication into the architecture, governance model, verification surface,
              or institutional path.
            </p>
          </div>
          <div className="flex flex-wrap gap-3">
            <Link
              href="/blueprint/#verifiable-stack"
              className="royal-button royal-button-primary rounded-lg bg-[#D4AF37] px-5 py-3 text-sm font-bold text-black transition hover:bg-[#F2D675]"
            >
              Explore architecture
            </Link>
            <Link
              href="/proof/"
              className="royal-button royal-button-ghost rounded-lg border border-[#B8860B]/60 px-5 py-3 text-sm font-bold text-[#F2D675] transition hover:bg-[#B8860B]/10"
            >
              Proof Registry
            </Link>
            <Link
              href="/applications/"
              className="royal-button royal-button-ghost rounded-lg border border-zinc-600 px-5 py-3 text-sm font-semibold text-zinc-200 transition hover:border-[#B8860B]/40"
            >
              Applications
            </Link>
          </div>

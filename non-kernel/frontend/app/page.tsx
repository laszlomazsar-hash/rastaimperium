    ...
    <main className="royal-page overflow-hidden">
      ...
      <section className="royal-hero relative border-b border-[rgba(242,214,117,0.18)]">
        ...
        <div className="container-page relative grid gap-10 py-14 sm:py-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-14 lg:py-24">
          ...
          <div className="hidden lg:block ri-reveal ri-reveal-delay-1">
            <RIHeroMark />
          </div>
        </div>
      </section>

      {/* 02 — TRUST RAIL (primary verification system surface) */}
      <section className="border-b border-zinc-900 bg-[#0b0c0b]/50">
        <div className="container-page py-7 sm:py-8">
          <div className="ri-reveal ri-reveal-delay-1">
            <TrustRail />
          </div>
        </div>
      </section>
          ...
          <div className="ri-reveal">
            ...
            <div className="mt-9 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              {[
                ...
                <div
                  key={item.title}
                  className="rounded-xl border border-[rgba(242,214,117,0.15)] bg-black/20 p-5 transition-colors hover:border-[rgba(242,214,117,0.28)]"
                >
          ...
          <div className="ri-reveal">
            ...
            <ol className="mt-9 grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
              {flowSteps.map((item) => (
                <li
                  key={item.step}
                  className="rounded-xl border border-zinc-800 bg-[#0b0c0b]/50 p-4 transition-colors hover:border-[rgba(242,214,117,0.22)]"
                >
      ...
      {/* 06 — PROVEN (Evidence observatory) — primary evidence surface */}
      <section className="border-b border-zinc-900 bg-[#0b0c0b]/35" aria-labelledby="evidence-heading">

...
const layers = [
  {
    id: "L9",
    title: "Cosmology",
    description: "Mythic narrative and civilizational meaning.",
  ...
  },
  {
    ...
    description: "Bayesian calibration and drift detection.",
    status: "UNAVAILABLE" as const,
  },
  {
    id: "L5",
    title: "Deterministic Intelligence",
    description: "Causal modeling and symbolic reasoning.",
    status: "UNAVAILABLE" as const,
  },
  {
    id: "L4",
    title: "Agentic Infrastructure",
    description: "Deep Seed agent orchestration.",
    status: "UNAVAILABLE" as const,
  },
  {
    id: "L3",
  ...
  },
  {
    ...
    description: "Progressive initiation and witness portals.",
    status: "UNAVAILABLE" as const,
  },
];
...
export default function HomePage() {
  return (
    <main className="royal-page overflow-hidden">
      ...
      <section className="royal-hero relative border-b border-[rgba(242,214,117,0.18)]">
        ...
        <div className="container-page relative grid gap-10 py-14 sm:py-16 lg:grid-cols-[1.15fr_0.85fr] lg:items-center lg:gap-14 lg:py-24">
          <div>
            ...
            <h1 className="royal-title mt-4 max-w-3xl text-4xl leading-[1.05] text-zinc-50 sm:text-5xl lg:text-6xl">
              RASTA IMPERIUM
            </h1>
            <p className="mt-4 max-w-xl text-lg leading-8 text-zinc-300 sm:text-xl">
              Constitutional intelligence infrastructure built around deterministic governance,
              verifiable evidence, and accountable machine decision-making.
            </p>
            <p className="mt-3 max-w-xl text-sm leading-7 text-zinc-500">
              Constitution · Intelligence · Verification
            </p>
          ...
          {/* Hero system glyph — restrained architecture silhouette */}
          <aside
            className="relative hidden overflow-hidden rounded-2xl border border-[rgba(242,214,117,0.2)] bg-[rgba(11,12,11,0.9)] p-6 lg:block"
            aria-hidden="true"
          >
            <p className="font-mono text-[10px] uppercase tracking-[0.2em] text-zinc-500">
              Civilization stack
            </p>
            <ol className="mt-4 space-y-1.5 font-mono text-xs text-zinc-400">
              {layers.map((l) => (
                <li
                  key={l.id}
                  className={`flex items-center gap-3 rounded px-2 py-1 ${
                    l.emphasize
                      ? "border border-emerald-800/40 bg-emerald-950/20 text-emerald-200"
                      : ""
                  }`}
                >
                  <span className="w-6 text-[#d4af37]">{l.id}</span>
          ...
          <div className="mt-10 grid gap-8 lg:grid-cols-3">
            <div>
              ...
              <p className="mt-2 text-sm leading-7 text-zinc-300">
                The public constitutional and verification surface. A civilization-scale project
                concerned with how autonomous systems remain accountable to explicit rules and
                inspectable records.
              </p>
            </div>
            <div>
              ...
              <p className="mt-2 text-sm leading-7 text-zinc-300">
                ...
                production execution runtime. It is the place where claims meet sealed evidence.
              </p>
            </div>
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[0.18em] text-[#d4af37]">
              ...
              <p className="mt-2 text-sm leading-7 text-zinc-300">
                Claims are labelled VERIFIED, DEMONSTRATION, or UNAVAILABLE. Verified means a
                frozen public capsule can be reproduced offline by independent pure verifiers.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="border-b border-zinc-900 bg-[#0b0c0b]/30" aria-labelledby="system-heading">
        <div className="container-page py-14 sm:py-16">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-zinc-400">
            From human interface to cosmology. Status reflects publicly frozen evidence on this
            surface — not importance ranking. L7 currently holds the strongest sealed capsules.
          </p>
      ...
      <section className="border-b border-zinc-900" aria-labelledby="evidence-heading">
        <div className="container-page py-14 sm:py-16">
          <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-[#d4af37]">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-zinc-400">
            Inspect what is established. Distinguish it from what remains demonstration or
            unavailable. Capsule-scoped only — not production LIVE telemetry.
          </p>
      ...
      {/* 06 — VERIFY CTA */}
      <section className="border-b border-zinc-900 bg-[#0b0c0b]/40" aria-labelledby="verify-heading">
        <div className="container-page py-14 sm:py-16">
          <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-[#d4af37]">
            Verification
          </p>
          ...
          <p className="mt-4 max-w-xl text-sm leading-7 text-zinc-400">
            Download a sealed capsule, run a pure verifier offline, and compare deterministic
            results. The website UI is not the proof — the hashes are.
          </p>
          <div className="mt-8">
            <Link
              href="/verify/"
      ...
      <section className="border-b border-zinc-900" aria-labelledby="reproduce-heading">
        <div className="container-page py-14 sm:py-16">
      ...
      {/* 08 — LIMITATIONS */}
      <section className="border-b border-zinc-900 bg-[#0b0c0b]/30" aria-labelledby="limits-heading">
        <div className="container-page py-14 sm:py-16">
          <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-[#d4af37]">
            Epistemic hygiene
          </p>
          ...
          <p className="mt-3 max-w-2xl text-sm leading-7 text-zinc-400">
            A serious verification system makes its boundaries visible. Unproven does not mean
            false — it means sealed public artifacts are not yet attached.
          </p>
          ...
          <div className="mt-10 grid gap-4 sm:grid-cols-3">
            <div className="rounded-xl border border-emerald-800/35 bg-emerald-950/15 p-5">
              ...
              <p className="mt-1 text-xs leading-5 text-zinc-400">
                Three L7 capsules with independent Node + Python reproductions. Capsule-scoped
                only.
              </p>
            </div>
          ...
          <div className="mt-8">
            <Link href="/limitations/" className="text-sm text-[#F2D675] hover:underline">
      ...
      <section className="border-b border-zinc-900" aria-labelledby="codex-heading">
        <div className="container-page py-14 sm:py-16">
          ...
          <p className="mt-3 max-w-xl text-sm leading-7 text-zinc-400">
            Seven Articles defining the constitutional principles surrounding the system. These
            are design principles — not automatically proven production properties. Where sealed
            capsules exist, status is labelled.
          </p>
          <div className="mt-8">
            <Link
              href="/codex"
      ...
      <section className="border-b border-zinc-900 bg-[#0b0c0b]/20" aria-labelledby="inst-heading">
        <div className="container-page py-14 sm:py-16">
          ...
          <p className="mt-3 max-w-xl text-sm leading-7 text-zinc-400">
            For organisations exploring constitutional intelligence systems, governance
            architecture, verification, or fixed-scope design partner pilots. Evidence first;
            commercial engagement only after scope is written and Limitations are read.
          </p>
          <div className="mt-8">
            <Link
              href="/institutional-pilots"
              className="rounded-lg border border-zinc-600 px-6 py-3 text-sm text-zinc-200 transition hover:border-[#B8860B]/40 hover:text-[#F2D675]"
            >

    ...
    <main className="royal-page overflow-hidden">
      ...
      <section className="container-page border-b border-zinc-900 py-12">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          {[
            { title: "Problem", body: "A decision path that cannot be reconstructed or bounded creates liability." },
            { title: "Method", body: "Freeze capsules, independent verifiers, written success criteria." },
            { title: "Boundary", body: "Capsule-scoped claims only. Unproven metrics stay UNAVAILABLE." },
          ].map((c) => (
      ...
      <section className="container-page border-b border-zinc-900 py-14">
        <div className="flex flex-wrap items-center gap-2">
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#B8860B]">CS-001 · methodology</p>
        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-2">
          {[
            { t: "01 · Problem", b: "Systems change state in ways operators cannot reconstruct: which rule applied, whether an illegal transition was attempted, whether the audit trail still matches live memory." },
            { t: "02 · Approach", b: "Freeze public capsules for deterministic replay parity and illegal lifecycle rejection. Independent Node and Python verifiers must exit 0 on sealed hashes." },
            { t: "03 · Evidence", b: "ART-L7-REPLAY-001, ART-L7-REJECT-001, ART-L7-PARITY-001 — all VERIFIED on the public Proof Registry." },
            { t: "04 · Boundary", b: "Capsule-scoped only. Performance numbers remain UNAVAILABLE until sealed benchmark artifacts exist." },
          ].map((x) => (
        ...
        <div className="mt-8 flex flex-wrap gap-4 text-sm">
          <Link href="/proof/" className="font-semibold text-[#F2D675]">Open Proof Registry →</Link>
          <Link href="/challenge/" className="text-zinc-400 hover:text-[#F2D675]">Challenge Lab →</Link>
        </div>
      </section>

      <section className="container-page border-b border-zinc-900 py-12">
        <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#B8860B]">Institutional cases</p>

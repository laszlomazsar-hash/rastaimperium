...
const offered = [
  ...
  "Integration support for invariant enforcement on agreed surfaces",
];

const notOffered = [
  "Unlimited agent coverage or self-serve SaaS",
  "Production guarantees without sealed artifacts",
  "Certification language beyond published evidence",
  "Open-ended consulting without written scope",
];
    ...
    <main className="royal-page overflow-hidden">
      ...
      <section className="container-page border-b border-zinc-900 py-12">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          ...
          >
            <p className="font-mono text-[11px] uppercase tracking-wider text-[#D4AF37]">Model</p>
            <p className="mt-2 font-semibold text-zinc-100">Governance model</p>
            <p className="mt-2 text-sm text-zinc-400">Legal transitions, receipts, lineage.</p>
          </Link>
          <Link
            href="/pillars/"
            className="royal-panel block rounded-xl border p-5 transition hover:border-[#B8860B]/40"
          >
            ...
            <p className="mt-2 text-sm text-zinc-400">Constitutional intent vs evidence labels.</p>
          </Link>
          <Link
            href="/proof/"
            className="royal-panel block rounded-xl border p-5 transition hover:border-[#B8860B]/40"
      ...
      <section className="container-page border-b border-zinc-900 py-12">
        <div className="grid gap-8 lg:grid-cols-2">
          <div>
            <h2 className="font-cinzel text-xl text-zinc-100">What a pilot includes</h2>
          ...
          <div>
            <h2 className="font-cinzel text-xl text-zinc-100">What a pilot is not</h2>
        ...
        <p className="mt-8 text-sm text-zinc-500">
          Indicative investment $50k–$150k for an 8–12 week fixed scope. See{" "}

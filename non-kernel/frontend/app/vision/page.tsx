...
const principles = [
  ["A clear boundary", "Separate public meaning, institutional policy, and execution logic so responsibility remains visible."],
  ["A durable witness", "Treat replay, lineage, and auditability as first-class properties of the system—not documentation added after the fact."],
  ["A human horizon", "Build for the people who must govern, challenge, and ultimately live alongside autonomous infrastructure."],
];
    ...
    <main className="overflow-hidden">
      <section className="relative border-b border-[#B8860B]/20">
        ...
        <div className="container-page relative grid gap-14 py-20 lg:grid-cols-[1.15fr_0.85fr] lg:items-end lg:py-28">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.32em] text-[#D4AF37]">Vision / 01</p>
            ...
            <p className="mt-8 max-w-2xl text-lg leading-8 text-zinc-300 sm:text-xl">
              Rasta Imperium imagines autonomous infrastructure that can act with discipline, account for its decisions, and remain understandable to the institutions it serves.
            </p>
          ...
          <aside className="relative border border-[#B8860B]/30 bg-[#0b0c0b]/70 p-6 shadow-2xl shadow-black/30 backdrop-blur sm:p-8">
            ...
            <p className="font-courier text-[0.68rem] uppercase tracking-[0.22em] text-[#D4AF37]">Statement of intent</p>
            ...
            <div className="mt-8 grid grid-cols-3 border-t border-[#B8860B]/20 pt-5 text-center">
              ...
              <div className="border-r border-[#B8860B]/20 px-2">
                ...
                <p className="mt-1 text-[0.64rem] uppercase tracking-[0.16em] text-zinc-500">Constraint</p>
              </div>
              <div className="px-2">
      ...
      <section className="container-page py-20 lg:py-28">
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#D4AF37]">The proposition</p>
            <h2 className="mt-5 text-3xl leading-tight text-zinc-100 sm:text-4xl">From managed models to governed systems.</h2>
          </div>
          <div className="max-w-2xl space-y-5 text-lg leading-8 text-zinc-300">
            <p>
              High-consequence systems need more than quality targets. They need an operating context that makes authority, limits, evidence, and recovery paths explicit.
            </p>
            <p>
              EVO-V is conceived as that context: a deterministic governance architecture that turns principles into inspectable operational boundaries. Rasta Imperium is the public interface for understanding why those boundaries matter.
            </p>
          </div>
        </div>
        ...
        <div className="mt-14 grid gap-px overflow-hidden border border-[#B8860B]/25 bg-[#B8860B]/20 md:grid-cols-3">
          {commitments.map((commitment) => (
            <article key={commitment.number} className="group relative bg-[#0b0c0b]/95 p-7 transition duration-300 hover:bg-[#121512] sm:p-8">
      ...
      <section className="border-y border-[#B8860B]/15 bg-black/20">
        <div className="container-page py-20 lg:py-24">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#D4AF37]">How we orient the work</p>
            <h2 className="mt-5 text-3xl text-zinc-100 sm:text-4xl">A sovereign system should be able to show its work.</h2>
          </div>
      ...
      <section className="container-page py-20 text-center lg:py-28">
        <p className="text-xs font-semibold uppercase tracking-[0.28em] text-[#D4AF37]">Continue the reading</p>
        <h2 className="mx-auto mt-5 max-w-3xl text-3xl leading-tight text-zinc-100 sm:text-4xl">
          See how the vision becomes a technical architecture.
        </h2>
        <div className="mt-9 flex flex-wrap justify-center gap-4">
          <Link href="/technology" className="rounded-lg bg-[#107e3e] px-6 py-3 text-sm font-bold text-white transition duration-200 hover:-translate-y-0.5 hover:bg-[#159450] active:scale-[0.97]">
            View technology overview
          </Link>
          <Link href="/contact" className="rounded-lg border border-zinc-600 px-6 py-3 text-sm font-semibold text-zinc-200 transition duration-200 hover:border-[#D4AF37]/70 hover:text-[#F2D675] active:scale-[0.97]">

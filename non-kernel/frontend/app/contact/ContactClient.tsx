        ...
        <div className="grid gap-12 lg:grid-cols-[minmax(0,1.2fr)_minmax(18rem,0.8fr)] lg:items-end">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-xs leading-5 text-zinc-500">
              Evidence → understanding → evaluation → conversation. Review Verify and Limitations before
              any commercial discussion. Contact does not create a pilot or investment agreement.
            </p>
          </div>
